<template>
  <div>
    <HeaderComp
      :title="'Minimaler Spannbaum berechnen 1'"
    ...
    />
    <br/>
    <NewTaskComp :task="'ExerciseDescending'" />

    <NextTaskComp @next_task="reloadPage()" />
...
<script>
import ExerciseDescendingGraph from '@/components/ExerciseDescendingGraph.vue'
